          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <a target='blank' href="https://www.instagram.com/rclanalytics?igsh=MWQ1enY2eDhsamdvNg==" className="hover:underline ">Instagram</a>
                </li>
                <li>
                  <a target='blank' href="https://www.linkedin.com/company/rcl-analytics/" className="hover:underline">Linkedin</a>
                </li>
              </ul>
            </div>
            <div>
