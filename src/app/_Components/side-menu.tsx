    ...
    return(
        <nav className="text-left ">
            <ul className="pt-10 text-right">
                ...
                <li><a href="" className="text-white text-xl font-light py-5 px-5 block transition duration-200 ">Portfólio</a></li>
                <li><a href="" className="text-white text-xl font-light py-5 px-5 block transition duration-200 ">Praticas</a></li>
                <li><a href="" className="text-white text-xl font-light py-5 px-5 block transition duration-200 ">Percepções</a></li>
